...
const AboutUs = () => {
  return (
    <div className="h-min-screen w-full">
      ...
      >
        <h1 className="text-5xl md:text-6xl font-light uppercase text-white text-center">
        ...
        >
          ...
          <div className="w-full h-auto flex flex-col sm:flex-row-reverse justify-start">
            <div className="w-full sm:w-1/2 h-56 sm:h-96 bg-banner-image bg-center bg-cover"></div>
            <div className="w-full sm:w-1/2 bg-stone-800 h-auto flex flex-row gap-x-4 py-4 sm:pe-4 pe-0">
              <p className="text-white text-justify">
                {contentData["how-can"]}
              </p>
            </div>
